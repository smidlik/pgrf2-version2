...
public class Mat3 {
     ...
     *
     * @param v1 row 0 vector (M00, M01, M02)
     * @param v2 row 1 vector (M10, M11, M12)
     * @param v3 row 2 vector (M20, M21, M22)
     */
     ...
     *
     * @param m 3x3 matrix to be cloned
     */
     ...
     *
     * @param m double array of length 9 (asserted)
     */
     ...
     *
     * @param m 2D double array of length 3x3 (asserted)
     */
    public Mat3(final double[][] m) {
        assert (m.length >= 3);
        for (int i = 0; i < 3; i++) {

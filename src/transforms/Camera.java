...
public class Camera {
     ...
     * mode flag
     *
     * @param cam         camera to be copied
     * @param firstPerson boolean flag indicating 1st (true) / 3rd (false) person camera
     *                    mode
     */
     ...
     *
     * @param cam    camera to be copied
     * @param radius distance between the eye (camera origin) and the observer
     ...
     *
     * @param cam     camera to be copied
     * @param azimuth angle (in radians) between the xz and uv planes where v is the
     ...
     * @param zenith  angle (in radians) between the view vector and z-axis
     */
     ...
     *
     * @param ang azimuth change in radians
     ...
     * kept >= 0.1
     *
     * @param dist radius change amount
     * @return new Camera instance
     */
     ...
     * kept in [-pi/2, pi/2]
     *
     * @param ang zenith change in radians
     * @return new Camera instance
     */
     ...
     *
     * @param speed distance to move by
     * @return new Camera instance
     */
     ...
     * Radius is kept >= 0.1
     *
     * @param scale radius scale coefficient
     * @return new Camera instance
     */

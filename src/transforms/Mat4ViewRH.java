...
public class Mat4ViewRH extends Mat4Identity {
     ...
     *
     * @param e eye, position of the observer frame origin with respect to the
     *          current frame
     * @param v view vector, the direction of the observer frame -z axis with
     *          respect to the current frame
     * @param u up vector, together with eye and view vector defines with

...
public class Quat {
     ...
     *
     * @param q quaternion to be cloned
     */
    public Quat(Quat q) {
        i = q.i;
        j = q.j;
     ...
     *
     * @param alpha rotation angle about x-axis, in radians
     * @param beta  rotation angle about y-axis, in radians
     * @param gamma rotation angle about z-axis, in radians
     * @return new Quat instance
     */
     ...
     *
     * @param a scalar value of type double
     * @return new Quat instance
     */
     ...
     *
     * @param quat    the vector to compare with.
     ...
     *
     * @param format String format applied to the coordinate

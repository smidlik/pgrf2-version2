...
public class Col {
     ...
     * as RGBA channels
     *
     * @param p point as an instance of Point3D
     */
     ...
     * alpha to 1.0
     *
     * @param rgb int-packed RGB, B in the LSB, MSB ignored
     */
     ...
     *
     * @param argb    int-packed ARGB, B in the LSB, alpha in the MSB or MSB
     *                ignored, based on isAlpha
     * @param isAlpha flag to indicate whether to interpret the MSB as alpha channel
     ...
     *
     * @param r red channel as an int in [0,255]
     * @param g green channel as an int in [0,255]
     * @param b blue channel as an int in [0,255]
     */
     ...
     * @param g green channel as an int in [0,255]
     * @param b blue channel as an int in [0,255]
     * @param a alpha channel as an int in [0,255]
     */
     ...
     *
     * @param r red channel as a double in [0.0,1.0]
     * @param g green channel as a double in [0.0,1.0]
     * @param b blue channel as a double in [0.0,1.0]
     */
     ...
     * @param g green channel as a double in [0.0,1.0]
     * @param b blue channel as a double in [0.0,1.0]
     * @param a alpha channel as a double in [0.0,1.0]
     */
     ...
     *
     * @param x multiplication scalar coefficient (a double-precision floating
     *          point)
     * @return new instance of Col
     */
     ...
     * [0.0,1.0]) performed.
     *
     * @param c color to per-channel multiply by
     * @return new instance of Col
     */
     ...
     * remains the same
     *
     * @param gamma power to which the RGB channels are raised
     * @return new instance of Col
     */
     ...
     *
     * @param col     the color to compare with.
     ...
     *
     * @param format String format applied to each channel

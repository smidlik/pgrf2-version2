...
public class Bicubic {
     ...
     *
     * @param baseMat base matrix, for instance Cubic.BEZIER
     * @param p11
     * @param p12
     * @param p13
     * @param p14
     ...
     *
     * @param baseMat base matrix, for instance Cubic.BEZIER
     * @param points  array of 16 control points
     */
     ...
     * @param baseMat    base matrix, for instance Cubic.BEZIER
     * @param points     array of 16 control points
     * @param startIndex offset to the point to start at
     */
     ...
     *
     * @param paramU u parameter from [0,1]
     * @param paramV v parameter from [0,1]
